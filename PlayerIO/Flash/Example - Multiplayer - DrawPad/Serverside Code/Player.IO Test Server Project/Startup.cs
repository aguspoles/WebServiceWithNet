...
namespace DevelopmentTestServer {
	public static class Startup {
		...
		static void Main() {
			...
			//
			// PlayerIO.DevelopmenPlayerIO.DevelopmentServer.Server.StartWithDebugging("<Enter your gameid here>", "public", new Dictionary<string, string>() { { "userId", "bob" } }, null, "FridgeMagnets", null, null, 30000);
